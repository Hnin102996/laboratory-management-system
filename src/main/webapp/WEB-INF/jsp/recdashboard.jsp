...
<form:form action="" method="POST" modelAttribute="reception">
  ...
  <!--  <div class="col-lg-15">-->
	<main class="main-content border-radius-lg ">
		...
		<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
  			<div class="container-fluid py-1 px-3">
    			<nav aria-label="breadcrumb">
        			...
        			<li class="breadcrumb-item text-sm text-info active" aria-current="page">Reception Dashboard</li>
      				</ol>
      				<h6 class="font-weight-bolder mb-0 text-info">Reception Dashboard</h6>      
    			</nav>    
  			</div>
		</nav>
		...
		<div class="container-fluid py-4">
			<img src="${pageContext.request.contextPath}/images/rec1.jpg" style="width: 1100px; height: 600px;">
		</div>
	</main>
</form:form>
