	 ...
	 <div class="collapse navbar-collapse  w-auto sidenav-body" id="sidenav-collapse-main">
    	<ul class="navbar-nav">
     		<li class="nav-item">
    			...
    			<a class="nav-link text-white " href="showReceptionHome">
  			...
  			<li class="nav-item">  				
    			...
    			<img src="${pageContext.request.contextPath}/images/ptreg.jfif" style="height: 40px;width: 50px;"><span class="nav-link-text ms-1">Patient Registration</span>
  				</a>
  				</div>
			</li>
